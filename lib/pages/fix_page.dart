...
//import 'package:whater_project1/add_new_item.dart';
...
class Repair extends StatefulWidget {
  ...
  @override
  State<Repair> createState() => _MyHomeState();
}

class _MyHomeState extends State<Repair> {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          String elementDateStr;
          for (var element in snapshot.data!.docs) {
            elementDateStr = (element.data() as Map)['date'].toString();
            ...
            if (DateTime.now()
                .isAfter(elementDate.add(const Duration(days: 120)))) {
                              ...
                              subtitle: Row(
                                ...
                                children: [
                                  ...
                                  Column(
                                    children:[
                                      Row(children: [
                                        const Text("تم الصيانة"),
                                        Transform.scale(
                                          scale: 0.7,
                                          child: Switch(
                                            
                                            value: isFixed, onChanged: (value){
                                              setState(() {
                                                isFixed=!isFixed;
                                              });
                                            }),
